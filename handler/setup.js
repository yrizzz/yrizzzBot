...
const handler = {
    ...
    base: {
        ...
        printQRInTerminal: false, // Print the qr in terminal? - Default: false
        ...
        usePairingCode: true, // Connect the bot using pairing code method instead of qr method. - Default: false
